...
Lines_window::Lines_window(Point xy, int w, int h, const string& title)
    ...
    next_x{Point{300,0}, 60, 40, "next x:"},
    next_y{Point{450,0}, 60, 40, "next y:"},
    xy_out{Point{100,0}, 100, 40, "current (x,y):"},
    color_menu{Point{x_max() - 150, 40}, 150, 40, Menu::vertical, "color"},
    color_button{Point{x_max() - 150, 40}, 150, 40, "color menu",
        [](Address, Address pw) {
            reference_to<Lines_window>(pw).color_pressed();
        }
    },
    style_menu{Point{x_max()-300, 40}, 150, 40, Menu::vertical, "style"},
    style_button{Point{x_max()-300, 40}, 150, 40, "style menu",
        [](Address, Address pw) {
